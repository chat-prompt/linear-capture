...
### Definition of Done
- [ ] `bun test` 전체 테스트 통과
- [ ] 영어 시스템에서 앱 실행 시 영어로 표시
- [ ] 한국어 시스템에서 앱 실행 시 한국어로 표시
- [ ] Settings에서 언어 변경 시 즉시 반영 (새로고침 없이)
- [ ] 앱 재시작 후에도 선택한 언어 유지
...
- [ ] System locale auto-detected on first run
